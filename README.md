...
- [Observacao sobre o BERT](#observacao-sobre-o-bert)
- [1. Visao Geral](#1-visao-geral)
- [Objetivos pedagogicos](#objetivos-pedagogicos)
- [2. O Que o Chatbot Faz](#2-o-que-o-chatbot-faz)
- [3. Arquitetura do Projeto](#3-arquitetura-do-projeto)
- [Diagrama geral da arquitetura](#diagrama-geral-da-arquitetura)
- [Camadas](#camadas)
- [4. Estrutura de Pastas](#4-estrutura-de-pastas)
- [5. Fluxo Completo de uma Mensagem](#5-fluxo-completo-de-uma-mensagem)
- [Diagrama do ciclo de requisicao](#diagrama-do-ciclo-de-requisicao)
- [Explicacao passo a passo](#explicacao-passo-a-passo)
- [6. Pre-processamento de Texto](#6-pre-processamento-de-texto)
- [O que ele faz](#o-que-ele-faz)
- [Por que isso importa?](#por-que-isso-importa)
- [Diagrama do pre-processamento](#diagrama-do-pre-processamento)
- [7. Classificacao de Intencoes](#7-classificacao-de-intencoes)
- [Diagrama da decisao](#diagrama-da-decisao)
- [Como o BERT e usado aqui](#como-o-bert-e-usado-aqui)
- [Fallback por palavras-chave](#fallback-por-palavras-chave)
- [8. Memoria e Contexto](#8-memoria-e-contexto)
- [Exemplo de dialogo com contexto](#exemplo-de-dialogo-com-contexto)
- [Diagrama da memoria](#diagrama-da-memoria)
- [9. Base de Conhecimento](#9-base-de-conhecimento)
- [Vantagem didatica](#vantagem-didatica)
- [10. Motor Principal do Chatbot](#10-motor-principal-do-chatbot)
- [Diagrama do motor](#diagrama-do-motor)
- [11. API FastAPI](#11-api-fastapi)
- [Endpoints disponiveis](#endpoints-disponiveis)
- [Exemplo de requisicao](#exemplo-de-requisicao)
- [Exemplo de resposta](#exemplo-de-resposta)
- [Por que usar FastAPI aqui?](#por-que-usar-fastapi-aqui)
- [12. Frontend Web](#12-frontend-web)
- [O que o frontend faz](#o-que-o-frontend-faz)
- [Diagrama do frontend](#diagrama-do-frontend)
- [13. Setup, Instalacao e Execucao](#13-setup-instalacao-e-execucao)
- [13.1 Clonar o repositorio](#131-clonar-o-repositorio)
- [13.2 Criar o ambiente virtual](#132-criar-o-ambiente-virtual)
- [13.3 Ativar o ambiente virtual](#133-ativar-o-ambiente-virtual)
- [13.4 Instalar as dependencias](#134-instalar-as-dependencias)
- [13.5 Rodar a aplicacao](#135-rodar-a-aplicacao)
- [13.6 Abrir no navegador](#136-abrir-no-navegador)
- [13.7 Encerrar a aplicacao](#137-encerrar-a-aplicacao)
- [14. Sobre o Uso de BERT](#14-sobre-o-uso-de-bert)
- [Comportamento padrao](#comportamento-padrao)
- [Se quiser permitir download automatico do modelo](#se-quiser-permitir-download-automatico-do-modelo)
- [Resumo da logica](#resumo-da-logica)
- [15. Exemplos de Perguntas para Teste](#15-exemplos-de-perguntas-para-teste)
- [Secretaria](#secretaria)
- [Financeiro](#financeiro)
- [Disciplinas](#disciplinas)
- [Professores](#professores)
- [Contexto](#contexto)
- [16. Ideias de Atividades para os Alunos](#16-ideias-de-atividades-para-os-alunos)
- [Atividade 1. Adicionar nova intencao](#atividade-1-adicionar-nova-intencao)
- [Atividade 2. Adicionar nova disciplina](#atividade-2-adicionar-nova-disciplina)
- [Atividade 3. Melhorar o pre-processamento](#atividade-3-melhorar-o-pre-processamento)
- [Atividade 4. Comparar abordagens](#atividade-4-comparar-abordagens)
- [Atividade 5. Avaliar desempenho](#atividade-5-avaliar-desempenho)
- [Atividade 6. Persistir memoria](#atividade-6-persistir-memoria)
- [17. Sugestoes de Experimentos em Sala](#17-sugestoes-de-experimentos-em-sala)
- [18. Recursos Uteis no Projeto](#18-recursos-uteis-no-projeto)
- [Recursos tecnicos ja implementados](#recursos-tecnicos-ja-implementados)
- [Recursos didaticos incluidos neste README](#recursos-didaticos-incluidos-neste-readme)
- [19. Possiveis Melhorias Futuras](#19-possiveis-melhorias-futuras)
- [20. Solucao de Problemas](#20-solucao-de-problemas)
- [A API nao sobe](#a-api-nao-sobe)
- [O BERT nao e carregado](#o-bert-nao-e-carregado)
- [O chatbot responde algo muito generico](#o-chatbot-responde-algo-muito-generico)
- [O contexto nao funcionou como esperado](#o-contexto-nao-funcionou-como-esperado)
- [21. Arquivos Mais Importantes para Estudo](#21-arquivos-mais-importantes-para-estudo)
